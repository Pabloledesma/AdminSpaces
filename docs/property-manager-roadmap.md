...
- [X] **Historia 3.1:** Como visitante, quiero acceder a un sitio público (LWR) donde pueda ver el proyecto en funcionamiento, para evaluar las habilidades del desarrollador. *(sitio `AdminSpaces` creado con template en blanco y publicado; ver notas de seguimiento)*
- [X] **Historia 3.2 (antes Historia 1.3 / 5.2):** Como visitante no autenticado del sitio Experience, quiero ver únicamente los registros marcados como `Is_Demo__c = true`, para que el portafolio sea público sin exponer datos reales del hogar — configurando OWD y Sharing Rules por criterio para el Guest User, aplicando el principio de menor privilegio. *(varias causas reales encadenadas; ver notas de seguimiento)*
...
- [X] **Historia 4.1:** Como huésped, quiero poder registrarme e iniciar sesión en el sitio, para hacer seguimiento de mi reserva sin depender de que el administrador me la comunique manualmente. *(varias causas encadenadas, incluida una no versionable; ver notas de seguimiento)*
