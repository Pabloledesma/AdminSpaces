...
- 🟡 **Hito 5** — Componentes LWC (dashboard de propiedad, chequeo de disponibilidad, creación de reserva y kanban de mantenimiento con Platform Events listos; falta la historia 5.5)
- ⬜ **Hito 6** — Agentforce
